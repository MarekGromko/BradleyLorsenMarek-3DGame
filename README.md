...
### ✅ Semaine 11 – Conception et scènes de base
- ✅ Élaborer le concept du jeu (thème, genre, but du joueur, identité visuelle).
- ✅ Créer les scènes de base des deux niveaux :
    - ✅ primitives 3D (cube, plane, sphere, capsule),
    - ✅ éclairage, textures et skybox,
    - ✅ organisation de la hiérarchie Unity (Assets/Scenes, Assets/Prefabs, etc.).
